...
effect give @s[nbt={HandItems:[{id:"minecraft:shield"}]}] minecraft:resistance 10 3 true
effect give @s[nbt={HandItems:[{id:"minecraft:netherite_sword"}]}] minecraft:strength 10 0 true